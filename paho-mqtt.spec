...
Source0  : https://files.pythonhosted.org/packages/59/11/1dd5c70f0f27a88a3a05772cd95f6087ac479fac66d9c7752ee5e16ddbbc/paho-mqtt-1.5.0.tar.gz
...
%prep
%setup -q -n paho-mqtt-1.5.0
cd %{_builddir}/paho-mqtt-1.5.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1588182207
...
cp %{_builddir}/paho-mqtt-1.5.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/paho-mqtt/ce0053083d3761c5b4d0e15b8ae3182034fe3138
